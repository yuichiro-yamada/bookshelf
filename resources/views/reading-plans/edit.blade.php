                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('reading-plans.update', $readingPlan) }}" method="POST" novalidate>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="target_date" id="target_date" value="{{ old('target_date', $readingPlan->target_date->format('Y-m-d')) }}" min="{{ now()->format('Y-m-d') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            @error('target_date')
